...
*   **Stabilität:** Durch den Einsatz von **[Load Balancing Loss](Load-Balancing-Loss.md)** und **[Top-k-Routing](Top-k-Routing.md)** wird die Spezialisierung der Experten erzwungen und ein *Expert Collapse* verhindert.
