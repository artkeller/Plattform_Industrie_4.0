...
Statt in jeder Transformer-Schicht eine einzelne, „dichte“ **[Feed-Forward-Schicht (FFN)](Feed-Forward-Schicht-(FFN).md)** zu nutzen, ersetzt MoE genau diese FFN-Schicht durch ein spezielles MoE-Modul. Dieses Modul besteht aus zwei Teilen:
...
Der entscheidende Vorgang ist die **sparsame Aktivierung** [(sparse activation)](Sparse-Mixture-of-Experts-Architecture.md): Von hunderten Milliarden Parametern sind pro Token nur ein Bruchteil aktiv. Der Rest „schläft“. Dadurch bleibt die reale Rechenlast pro Token gering – und genau das macht MoE so mächtig.
