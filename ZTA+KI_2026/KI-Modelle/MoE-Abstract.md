...
wobei $$G(x)$$ ein sparse Gating-Vektor mit ausschließlich Top-
$$
k
$$
Einträgen ungleich null ist. Zur Vermeidung von Expert Collapse wird eine zusätzliche Load-Balancing-Loss-Funktion 
